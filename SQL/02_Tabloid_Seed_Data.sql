...
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (1, 'rsandwith0', 'Reina', 'Sandwith', 'test@test.net', '2020-04-23', 'https://robohash.org/numquamutut.png?size=150x150&set=set1', 1, 'tcDLP9Qp9UZFVsv4J4y4Sz5bsE73');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (2, 'rdo1', 'Red', 'Do', 'test@test.test', '2020-04-20', 'https://robohash.org/nisiautemet.png?size=150x150&set=set1', 2, 'iKeaEGbm1UXfHSFIkQokafONNrE3');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (3, 'aotton2', 'Arnold', 'Otton', 'test@test.org', '2020-01-13', 'https://robohash.org/molestiaemagnamet.png?size=150x150&set=set1', 1, 'YKQz2AKdp0QAUVxQktd2M6iJ0LQ2');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (4, 'agrzeskowski3', 'Aharon', 'Grzeskowski', 'test@test.io', '2020-04-12', 'https://robohash.org/doloremfugiatrerum.png?size=150x150&set=set1', 1, 'LkjaUiACYRR1qbbVLvVvA25TNbp2');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (5, 'ryakushkev4', 'Rosana', 'Yakushkev', 'test@test.edu', '2019-08-16', 'https://robohash.org/deseruntutipsum.png?size=150x150&set=set1', 1, 'Jn1ZOK0qO6d2MjpA37yMEm9oucV2');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (6, 'tfigiovanni5', 'Tobi', 'Figiovanni', 'test@test.com', '2019-10-17', 'https://robohash.org/quiundedignissimos.png?size=150x150&set=set1', 2, '1AO3MWCwxtNUlPCsu8Tb7prjPYh2');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (7, 'gteanby6', 'Giuseppe', 'Teanby', 'test@test.xyz', '2019-08-29', 'https://robohash.org/hicnihilipsa.png?size=150x150&set=set1', 1, 'SDpnPPBou0XYWj70wiylgKqNo5C2');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (8, 'cvanderweedenburg7', 'Cristabel', 'Van Der Weedenburg', 'test@test.abc', '2019-11-02', 'https://robohash.org/quidemearumtenetur.png?size=150x150&set=set1', 1, 'dgWTXuxVP8Vt81hV0KbnbscBdhD3');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (9, 'ecornfoot8', 'Emmaline', 'Cornfoot', 'test@test.123', '2020-02-17', 'https://robohash.org/blanditiismaioresest.png?size=150x150&set=set1', 2, 'e0LNazg0T4dlpjl2yT2H2fD8RIt1');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (10, 'jmaruska9', 'Jody', 'Maruska', 'test@test.no', '2020-02-09', 'https://robohash.org/voluptatemexercitationemdignissimos.png?size=150x150&set=set1', 1, '5UwwsHhY31c8iTg8RwJlY6M8F9o2');
